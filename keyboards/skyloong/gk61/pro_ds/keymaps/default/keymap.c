...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
     * │Ctl│GUI│Alt│   │Spc│Spc│   │   |Spc|Alt│Mox│App│   │Ctl|
     * └───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┘
     */
    [_WIN] = LAYOUT_all(
        ...
        KC_LCTL,KC_LGUI,MT(MOD_LALT,KC_LNG2),KC_SPC,KC_SPC,KC_SPC,MT(MOD_LALT|MOD_RALT,KC_LNG1),MO(_WIN_INDEX),KC_APP,KC_RCTL
    ),
     ...
     [_MAC] = LAYOUT_all(
        ...
        KC_LSFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_N,KC_M,KC_COMM,KC_DOT,KC_SLSH,KC_RSFT,
        KC_LCTL,KC_LGUI,MT(MOD_LALT,KC_LNG2),KC_SPC,KC_SPC,KC_SPC,MT(MOD_LALT|MOD_RALT,KC_LNG1),MO(_MAC_INDEX),KC_APP,KC_RCTL
    ),
    ...
    [_WIN_INDEX] =  LAYOUT_all(
        ...
        KC_LCTL,KC_LGUI,MT(MOD_LALT,KC_LNG2),KC_SPC,KC_SPC,KC_SPC,MT(MOD_LALT|MOD_RALT,KC_LNG1),KC_NO,KC_APP,KC_RCTL
    ),
